export const curatedPackages = [
  ...
  },
  {
    ...
    currency: 'R$',
    image_url: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80',
    description: 'Experiência de alta gastronomia e vida selvagem com vilas privativas na reserva fechada de Sabi Sands, voo cênico de helicóptero sobre Cape Town.',
    included_services: [
  ...
  },
  {
    ...
    description: 'Descubra as Grandes Pirâmides de Gizé com egiptólogo PhD privativo fora do horário público.',
    included_services: [
